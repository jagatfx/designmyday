  ...
  Account.find({}).sort({city: 1}).exec(function (err, accounts) {
    ...
    var filteredAccounts = accounts.map(function(account) {
      var filterAccount = {
        ...
        numFeelings: account.historicFeelings ? account.historicFeelings.length : 0,
        numSeverity: account.historicSeverity ? account.historicSeverity.length : 0,
        numFeedback: account.feedbackReports ? account.feedbackReports.length : 0,
